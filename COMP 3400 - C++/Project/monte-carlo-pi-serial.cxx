...
int main()
{
  ...
  auto result = monte_carlo<tally_predicate>(swsc, []() {
  	 static decltype(make_randomly_seeded_mt19937_64_engine()) xre = make_randomly_seeded_mt19937_64_engine();
  	 static decltype(make_randomly_seeded_mt19937_64_engine()) yre = make_randomly_seeded_mt19937_64_engine();
